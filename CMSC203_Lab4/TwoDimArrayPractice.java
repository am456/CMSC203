   ...
   */
   public void printArray()
   {
    ...
    // Write your code here:
	   for (int row = 0; row < intArray.length; row++) //Iterates over each row in the array
	   {
		   for (int column = 0; column < intArray[row].length; column++) //Iterates over each column in curent row
		   {
